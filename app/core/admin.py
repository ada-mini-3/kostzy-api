...
admin.site.register(models.CommunityDiscussion)
admin.site.register(models.DiscussionComment)
admin.site.register(models.DiscussionLike)
admin.site.register(models.FeedImage)
admin.site.register(models.DiscussionImage)
